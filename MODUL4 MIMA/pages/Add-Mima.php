...
<nav class="navbar navbar-expand-lg bg-primary " >
  <div class=" d-flex justify-content-left container-fluid">
    ...
    <div class="mb-3">
		...
		<input type="text" id="namamobil" name="namamobil" class="form-control" placeholder="Kijang Innova">
	</div>

    <div class="mb-3">
		<label for="namapemilik">Nama Pemilik</label>
		<input type="text" id="namapemilik" name="namapemilik" class="form-control" placeholder="Nama - NIM">
	</div>

    <div class="mb-3">
		<label for="merk">Merk</label>
		<input type="text" id="merk" name="merk" class="form-control" placeholder="Toyota">
	</div>
    
    <div class="mb-3">
        <label for="tanggalbeli">Tanggal Beli</label>
        <input type="date" id="tanggalbeli" name="tanggalbeli" class="form-control" placeholder="mm / dd / yyyy">
    </div>
